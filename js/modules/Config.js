...
var Config = {
	...
	proxy: param('proxy') || 'wss://play.aardwolf.com:6200/',

	view: this.host + ':' + this.port + ':' + window.screen.width + 'x' + window.screen.height,
