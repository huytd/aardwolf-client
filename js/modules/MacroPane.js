...
var MacroPane = function (o) {
	...
	var init = function () {
		...
		Event.listen('before_send', sub);
		!view || view.echo('Activating macros.');
	...
	var pane = function () {
		...
		if (first) {
			...
			j('body').on('click', '.macro-btn', function () {
				...
				socket.write(msg), view.echo(msg);
			});
		}
	}
